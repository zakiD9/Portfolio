...
export default function ServicesSection(){
    ...
    return(
        <section id="services" className="relative w-screen flex flex-col min-h-[878px] gap-16 sm:gap-[96px] items-center px-4 sm:px-6 lg:px-[71px] py-16 sm:py-[116px] bg-[#171717] rounded-[30px] sm:rounded-[50px] overflow-hidden -translate-y-8 sm:-translate-y-0 md:-translate-y-15 lg:translate-y-0 -mt-14">
        <img
          src={backPic}
          alt="image"
